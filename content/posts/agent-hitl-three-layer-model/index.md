...
<!-- TODO: 图2 — 工具审批流程示意图：Agent 调用 send_email → 框架暂停 → 人类审批 -->
...
<!-- TODO: 图3 — Claude Code 提问截图：Agent 主动识别信息不足并向人类求助 -->
...
<!-- TODO: 图4 — 四种机制的流程对比图：拦截点位置不同（执行前/推理中/执行后） -->
...
<!-- TODO: 图5 — 滑动自主性示意图：L0（完全受控）到 L4（完全自主）的滑块 -->
