...
<!-- TODO: 图1 — Agent 执行链路流程图：用户指令 → Agent 推理 → 工具选择 → 工具执行（外部副作用） → 结果返回 -->
...
<!-- TODO: 图2 — 对话式AI vs Agent 对比图：控制权从人类转移到 Agent -->
...
<!-- TODO: 图3 — 双层防线架构图：上层软控制（System Prompt）+ 下层硬控制（框架拦截） -->
...
<!-- TODO: 图4 — Claude Code 提问截图：Agent 主动识别信息不足并向人类求助 -->
