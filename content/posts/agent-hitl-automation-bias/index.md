...
> **[图1：建议插入"盲审 vs 知情审批"的对比图]**
> 左：只显示 "send_email(to=team@company.com)" → 批准/拒绝
> 右：显示完整上下文——Agent 的推理、邮件全文、收件人列表的来源、风险提示
...
> **[图2：建议插入审批队列 UI 示意图]**
> 列表视图，每行显示：Agent 名称、待审批操作摘要、风险等级标签（红/黄/绿）、等待时长、操作按钮
> 高风险项高亮置顶
